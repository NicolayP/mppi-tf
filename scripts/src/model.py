...
def nn(model_dic, samples, dt, state_dim, action_dim,
...
def auv_nn(modelDict, samples, dt, state_dim, action_dim,
           limMax, limMin, name, paramFile=None):
    return NNAUVModel(weightFile=paramFile)

def pm(model_dic, samples, dt, state_dim, action_dim,
       limMax, limMin, name, paramFile=None):
...
def auv(modelDict, samples, dt, stateDim, actionDim,
        limMax, limMin, name, paramFile=None):
